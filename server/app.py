...
CORS(
    ...
    origins=[
        "http://localhost:3000",
        "http://192.168.124.235:3000",
        "https://vclass-xi.vercel.app",
    ],
    allow_headers=[
        "Content-Type",
        "Authorization",
            ...
            res = db["users"].insert_one(
                {
                    ...
                    "student": [],
                    "teacher": [],
                    "profile_url": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRT6mB9psRLZ1w3gSxezEl5ryhVBL3lGn6Yhw&s",
                }
            )
...
def home():
    return jsonify(
        {
            "message": "welcome to VClass server ( flask - " + flask.__version__ + " )",
            "success": True,
        }
    )
