...
function Sidebar({selected, full ,classname,handleChange}) {
  return (
    <div className={`w-[15rem] fixed top-0 left-0 overflow-x-hidden justify-start items-end pt-16 flex flex-col gap-2 z-30 top-0 duration-300 bg-secondery h-screen absolute ${full ? 'w-[15rem]' : 'w-[3rem]'} `}>
