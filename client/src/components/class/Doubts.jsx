                      ...
                      <div className='w-full'>
                        <div className='bg-secondery/70 mt-3 p-2 w-full flex flex-col gap-3 rounded-2xl'>
                          ...
                          <div className='flex gap-3 items-center'>
                            ...
                            <div className='flex items-center '>
                              <svg onClick={() => dislikeDoubt(c._id.$oid, c.user_reaction, ci)} xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-hand-thumbs-up hover:text-tersiory cursor-pointer p-[3px] rounded-full hover:bg-secondery/80" viewBox="0 0 16 16">
